...
~~~
wget -qO ~/pydio.zip http://downloads.sourceforge.net/project/ajaxplorer/ajaxplorer/stable-channel/5.0.4/ajaxplorer-core-5.0.4.zip
unzip -qo ~/pydio.zip
cp -rf ~/ajaxplorer-core-5.*/. ~/www/$(whoami).$(hostname)/public_html/pydio
...
~~~
rm -f ~/pydio.zip && rm -rf ~/ajaxplorer-core-5.*
~~~
